...
-- a line you can explain in one sentence.`,
      ...
      },
      {
        ...
        links: [{ label: "Type in a real editorial layout", href: "/prompts/print-inspired-editorial" }],
      },
    ],
  },
  {
...
Run 3  fid 93   shipping.`,
      ...
      },
      {
        ...
        links: [{ label: "A run log you can learn from", href: "/learn/easing-cheatsheet-deep-dive" }],
      },
    ],
  },
  {
...
5. The evidence   before/after or a run log; what users said`,
      ...
      },
      {
        ...
        links: [{ label: "A motion spec built as a page", href: "/prompts/motion-spec-only" }],
      },
    ],
  },
  {
